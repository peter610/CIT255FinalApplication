    ...
    public static class ConsoleView
    {
        ...
        public static AppEnum.MenuOptions GetUserMenuOption()
        {
            ...
            Console.WriteLine(
                ...
                "6. Query By" + Environment.NewLine +
        ...
        /// <summary>
        /// method gets the manufacturer value for the query
        /// </summary>
        public static void GetManufacturerQueryValue(out string manufacturerValue)
        {
            //string userResponse = "";
            ...
            DisplayMessage("");
            Console.WriteLine(ConsoleUtil.Center("Query Firearms by Manufacturer", WINDOW_WIDTH));
            DisplayMessage("");

            DisplayPromptMessage("Enter the manufacturer: ");
            manufacturerValue = Console.ReadLine();
            ...
            DisplayMessage(String.Format("You have entered {0} as the manufacturer.", manufacturerValue));
